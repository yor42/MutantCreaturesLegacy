...
public class MutantSnowGolemModel extends ModelBase {
    ...
    public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        setAngles();
        animate((MutantSnowGolemEntity) entity, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale);
