...
public class MBTileEntityItemStackRenderer extends TileEntityItemStackRenderer {
    ...
    public void renderByItem(ItemStack itemStackIn) {
        if (itemStackIn.getItem() == MBItems.ENDERSOUL_HAND) {
            ...
            EndersoulCloneRenderer.render(player, ENDER_SOUL_HAND_TEXTURE, 0.0F, 0.0F, player.ticksExisted + Minecraft.getMinecraft().getRenderPartialTicks(), 0.0F, 0.0F, 0.0F, this.enderSoulHandModel, 1.0F);
