...
@Mod(modid = "mutantbeasts", name = "Mutant Creatures Legacy", version = "1.12.2-1.0.2", acceptedMinecraftVersions = "[1.12.2]", dependencies = "required-after:minecraft;required-after:forge@[14.23.5.2779,);")
